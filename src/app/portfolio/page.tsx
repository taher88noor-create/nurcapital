    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Investment rationale, market observations, and thesis updates
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <Note
          ...
          view="BUY signal issued for PANW. Existing BUY maintained for CRWD. Combined cybersecurity allocation: 12% of portfolio. Theme status: STRONG."
        />
        <Note
          date="2025-04-01"
          ...
          view="BUY signals issued for AMD and AVGO. Existing BUY maintained for TSM and ASML. Semiconductor theme allocation: 36% (approaching 35% soft limit — monitoring). Theme status: STRONG."
        />
        <Note
          date="2025-03-15"
          title="Portfolio Construction: Initial Allocation"
          theme="Portfolio Strategy"
          assets={["TSM", "ASML", "HLAL", "ABB"]}
          regime="Strong Bull"
          summary="Establishing core positions across 6 themes. Semiconductor exposure (TSM + ASML) as primary growth allocation. HLAL as Sharia-compliant diversification anchor. ABB as defensive industrial. Saudi Aramco for energy security and dividend income."
          risks="Semiconductor concentration at 22% from day one. Taiwan geopolitical risk. Regime could shift if breadth narrows."
          view="Initial allocation complete. 9 positions across 6 themes. Cash reserve at 20% (conservative for Strong Bull — maintaining optionality). All positions pass eligibility screening."
        />
        <Note
          date="2025-02-20"
          title="GLP-1 Revolution: Healthcare Allocation"
          theme="Healthcare"
          assets={["LLY", "NOVO-B"]}
          regime="Sideways"
          ...
          view="BUY signal for LLY (category leader, best efficacy data). HOLD for NOVO-B (in correction, fundamentals intact but momentum negative). Combined healthcare allocation: 13%."
        />
        <Note
          date="2025-02-01"
          ...
          view="HOLD signal. Positioned as dividend anchor and energy security exposure. 8% allocation. Low volatility, low correlation with tech holdings. Provides geographic diversification (GCC)."
        />
      </div>
