...
const CONVICTION_ASSETS: AssetMaster[] = [
  ...
  { ticker: "HTWD.L", name: "HSBC MSCI Taiwan Capped UCITS ETF", tags: ["Semiconductors", "Asia-Pacific", "Technology", "Chip Manufacturing"], type: "etf", exchange: "LSE", region: "Asia-Pacific", ajBell: true, screening: "approved", isin: "IE00B3S1J086", ajBellStatus: "eligible", inConvictionList: true, signalPrice: 45.82, signalDate: "2026-07-10", rating: "BUY", rationale: "Pure Taiwan semi exposure. TSMC ~35%. 0.30% TER.", regime: "Weak Bull", theme: "Semiconductors" },
  { ticker: "SEMI.L", name: "iShares MSCI Global Semiconductors UCITS ETF", tags: ["Semiconductors", "Microchips", "AI", "Global", "Technology"], type: "etf", exchange: "LSE", region: "Global", ajBell: true, screening: "approved", ajBellStatus: "eligible", inConvictionList: true, signalPrice: 5.75, signalDate: "2026-07-10", rating: "BUY", rationale: "Pure global semi ETF. +158% 1Y. 0.35% TER.", regime: "Weak Bull", theme: "Semiconductors" },
  ...
  { ticker: "RENW.L", name: "L&G Clean Energy UCITS ETF", tags: ["Clean Energy", "Grid Storage", "Infrastructure", "Global"], type: "etf", exchange: "LSE", region: "Global", ajBell: true, screening: "approved", ajBellStatus: "eligible", inConvictionList: true, signalPrice: 9.20, signalDate: "2026-07-10", rating: "HOLD", rationale: "Broader clean energy. Grid storage. 0.49% TER.", regime: "Weak Bull", theme: "Clean Energy" },
  ...
  { ticker: "VFEM.L", name: "Vanguard FTSE Emerging Markets UCITS ETF", tags: ["Emerging Markets", "Asia-Pacific", "Latin America", "Diversified"], type: "etf", exchange: "LSE", region: "Global", ajBell: true, screening: "approved", ajBellStatus: "eligible", inConvictionList: true, signalPrice: 52.00, signalDate: "2026-07-10", rating: "HOLD", rationale: "Cheapest EM exposure (0.22% TER). Use alongside ISDE.", regime: "Weak Bull", theme: "Emerging Market Champions" },
];
